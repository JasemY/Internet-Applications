...
namespace Ia.Cl.Model
{
    ...
    public class Kuwait
    {
        ...
        /// 
        /// </summary>
        public Kuwait(int itu)
        {
            Kuwait country;

            country = KuwaitAreaById(itu);
        ...
        ///
        /// </summary>
        public static Kuwait KuwaitAreaById(int id)
        {
            Kuwait kuwaitArea;
        ...
        ///
        /// </summary>
        public static SortedList KuwaitAreaSortedList
        {
            get
            {
                int id;
        ...
        ///
        /// </summary>
        public static List<Kuwait> KuwaitAreaList
        {
            get
            {
                List<Kuwait> kuwaitAreaList;
        ...
        public static XDocument XDocument
        {
            get
            {
                ...
                streamReader = new StreamReader(_assembly.GetManifestResourceStream("Ia.Cl.model.country.kuwait.xml"));
